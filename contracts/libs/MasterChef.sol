...
contract MasterChef is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;       // How many allocation points assigned to this pool. BOBA to distribute per block.
        uint256 lastRewardBlock;  // Last block number that BOBA distribution occurs.
        uint256 accBobaPerShare;   // Accumulated BOBA per share, times 1e12. See below.
